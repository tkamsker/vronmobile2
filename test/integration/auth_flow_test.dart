...
void main() {
  group('Authentication Flow Integration Tests', () {
    ...
    testWidgets('T026: Sign In button exists and has proper handler', (
      tester,
    ) async {
    ...
    testWidgets('T028: tapping Facebook button triggers Facebook OAuth flow', (
      tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: MainScreen()));
    ...
    testWidgets(
      'T029: tapping Forgot Password link triggers browser navigation',
      (tester) async {
        await tester.pumpWidget(const MaterialApp(home: MainScreen()));
    ...
    testWidgets(
      'T030: tapping Create Account link navigates to registration screen',
      (tester) async {
    ...
    testWidgets(
      'T031: tapping Continue as Guest button navigates to guest mode',
      (tester) async {
        bool navigationOccurred = false;
