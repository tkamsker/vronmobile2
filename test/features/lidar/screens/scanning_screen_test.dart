...
void main() {
  ...
  group('ScanningScreen Guest Mode', () {
    ...
    testWidgets('hides Save to Project button when in guest mode', (WidgetTester tester) async {
      ...
      expect(find.widgetWithText(ElevatedButton, 'Save to Project'), findsNothing);
    });

    testWidgets('shows Save to Project button when NOT in guest mode', (WidgetTester tester) async {
    ...
    testWidgets('shows Export GLB button in both modes', (WidgetTester tester) async {
      // Test in guest mode
      await guestManager.enableGuestMode();
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('displays guest mode banner when in guest mode', (WidgetTester tester) async {
      // Arrange
      await guestManager.enableGuestMode();
    ...
    testWidgets('does NOT display guest banner when authenticated', (WidgetTester tester) async {
