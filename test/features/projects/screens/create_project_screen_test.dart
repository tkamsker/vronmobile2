...
void main() {
  ...
  group('CreateProjectScreen Widget Tests (T011)', () {
    ...
    testWidgets('T011: auto-generates slug from name as user types',
      ...
      expect(slugWidget.controller!.text, equals('my-awesome-project'),
    ...
    testWidgets('T011: slug handles special characters and spaces correctly',
      ...
      final slugField = find.byType(TextFormField).at(1);
      final slugWidget = tester.widget<TextFormField>(slugField);
      expect(slugWidget.controller!.text, equals('product-1-2025'),
    ...
    testWidgets('T011: shows validation error for name too short',
      ...
      // Assert
      expect(find.text(AppStrings.projectNameTooShort), findsOneWidget,
    ...
    testWidgets('T011: shows validation error for name too long',
      ...
      // Assert
      expect(find.text(AppStrings.projectNameTooLong), findsOneWidget,
    ...
    testWidgets('T011: shows validation error for invalid slug format',
      ...
      // Assert
      expect(find.text(AppStrings.projectSlugInvalid), findsOneWidget,
          reason: 'Should show invalid format error for slug with spaces/special chars');
    });
    ...
    testWidgets('T011: disables save button during submission',
        (tester) async {
      // Arrange
      await tester.pumpWidget(
        const MaterialApp(
      ...
      final saveButton =
          find.widgetWithText(ElevatedButton, AppStrings.createProjectButton);
    ...
    testWidgets('T011: slug field is editable even after auto-generation',
      ...
      // Assert
      final slugWidget = tester.widget<TextFormField>(slugField);
      expect(slugWidget.controller!.text, equals('custom-slug'),
    ...
    testWidgets('T011: form resets properly after clearing all fields',
      ...
      final slugWidget = tester.widget<TextFormField>(slugField);
      expect(slugWidget.controller!.text, isEmpty,
