...
## Phase 3: User Story 1 - SDK and Core Dependencies Updated (Priority: P1) 🎯 MVP
...
- [ ] T092 Verify startup time within ±5% of baseline (per spec.md SC-004)
...
- [ ] T103 Verify no runtime crashes in standard workflows: login → project list → scan → export (per spec.md SC-008)

### Success Criteria Validation

- [ ] T104 Validate SC-001: iOS and Android builds complete without errors ✅
- [ ] T105 Validate SC-002: All automated tests pass (100% pass rate) ✅
- [ ] T106 Validate SC-003: flutter analyze shows zero errors, zero warnings ✅
- [ ] T107 Validate SC-004: App startup time within 5% of baseline ✅
- [ ] T108 Validate SC-005: Manual testing of auth, projects, scanning, file ops successful ✅
- [ ] T109 Validate SC-006: CLAUDE.md and code comments reflect Dart 3.8.1 / Flutter 3.32.4 ✅
- [ ] T110 Validate SC-007: Local development environment builds successfully ✅
- [ ] T111 Validate SC-008: No runtime crashes in standard workflows ✅
...
- [ ] T116 Create PR: 028-flutter-upgrade → stage (include performance comparison, summary of changes, validation results)
