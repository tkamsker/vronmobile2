...
🔘 [UI] Sign In button pressed
✅ [UI] Form validation passed
📡 [UI] Calling authentication service... 
🔐 [AUTH] Starting login for: tkamsker@gmail.com 
🔐 [AUTH] GraphQL mutation completed
✅ [AUTH] Received access token: eyJhbGci...
✅ [AUTH] Created AUTH_CODE: eyJNRVJD...
✅ [AUTH] Tokens stored securely
✅ [AUTH] GraphQL client refreshed with new auth
✅ [AUTH] Login successful
📡 [UI] Authentication service returned: SUCCESS
✅ [UI] Login successful - navigating to home screen
✅ [UI] Navigated to home screen
