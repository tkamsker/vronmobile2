...
lib/
  ...
  features/
    auth/                    # Feature 001: Authentication screens
      screens/
    home/
      models/                # Project model
      services/              # ProjectService for GraphQL operations
      screens/
    profile/                 # Profile and language screens
      screens/
...
- **Status**: Complete
- **Purpose**: Authentication entry point with OAuth support
- **Key Components**: MainScreen, login flow, OAuth placeholders
...
### Navigation
- Use AppRoutes constants from `lib/core/navigation/routes.dart`
- Pass arguments via `ModalRoute.of(context).settings.arguments`
- Return values via `Navigator.pop(result)`
- Example: `Navigator.pushNamed(context, AppRoutes.projectData, arguments: {...})`
...
- 001-main-screen-login: Initial authentication and main screen
