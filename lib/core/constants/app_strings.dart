...
class AppStrings {
  ...
  static const String oauthNetworkError =
      'Network error. Please check your connection and try again';
  static const String oauthServiceUnavailable =
      'Google sign-in is temporarily unavailable. Please try again later';
  static const String oauthInvalidCredentials =
      'Failed to obtain Google credentials';
  static const String oauthAuthenticationFailed =
      'Authentication failed. Please try again';
  static const String oauthBackendError =
  ...
  static const String guestModeBannerHint =
      'You are using the app without an account. Scans are saved on this device only.';
  static const String guestSignUpButtonSemantics = 'Sign Up';
  static const String guestSignUpButtonHint =
      'Create an account to save scans to the cloud';
  ...
  static const String projectNameTooShort =
      'Name must be at least 3 characters';
  static const String projectNameTooLong =
      'Name must be 100 characters or less';
  static const String projectSlugRequired = 'Slug is required';
  static const String projectSlugInvalid =
      'Slug must contain only lowercase letters, numbers, and hyphens';
  static const String projectSlugDuplicate =
  ...
  static const String projectDescriptionSemantics =
  ...
  static const String lidarNotSupported =
      'LiDAR scanning is not supported on this device';
  static const String lidarRequiresIPhone12Pro =
      'Requires iPhone 12 Pro or newer with LiDAR sensor';
  static const String lidarIOSOnly =
      'LiDAR scanning is only available on iOS devices';
  static const String lidarOldIOSVersion =
      'Requires iOS 16.0 or later for LiDAR scanning';

  // Scanning error messages
  static const String scanPermissionDenied =
      'Camera permission is required for LiDAR scanning';
  static const String scanPermissionDeniedDetail =
  ...
  static const String fileInvalidFormat =
      'Invalid file format. Please select a .glb file';
  ...
  static const String scanInterruptedMessage =
      'The scan was interrupted. What would you like to do?';
  ...
  static const String conversionUnsupportedGeometry =
      'Scan contains unsupported geometry';
  static const String conversionMissingTextures =
      'Some textures are missing or corrupted';
  static const String conversionMemoryExceeded =
      'Conversion requires too much memory';
  ...
  static const String startScanButtonHint =
      'Begin scanning the room with LiDAR sensor';
  ...
  static const String uploadGlbButtonHint =
      'Select and upload an existing GLB file';
  static const String scanProgressSemantics = 'Scan progress indicator';
  static const String scanProgressHint =
      'Shows the progress of the current scan';
}
